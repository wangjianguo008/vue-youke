<template>
<div>
    <mu-appbar title="黑名单" titleClass="titleClass">
        <mu-icon-button icon="keyboard_arrow_left" slot="left" @click="RouterOne" />
    </mu-appbar>
    <mu-text-field class="KeyWord-TopInput" label="输入用户昵称或实名,按回车添加" @change="add" v-model="text" icon="person_add" labelFloat/>
